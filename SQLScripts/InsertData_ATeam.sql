...
VALUES ("Personal Performance", "Effective leadership requires individuals to draw upon values, strengths, and abilities to deliver high standards of service. Demonstratingeffectiveself-awareness,self-management, continuedpersonal development and actingwith integrity.");

INSERT INTO competency(competencyName, competencyDescription)
VALUES ("Working with others", "Effective leadership requires individuals to work with others in teams and networks to deliver and improve services.  Mobilisingpeople in an inclusive way to drive continuous business improvement.");

INSERT INTO competency(competencyName, competencyDescription)
VALUES ("Setting Direction, Development and Accountability", "Effective leadership requires individuals to contribute to the aspirations of Kainos and act in a manner consistent with our values. Demonstratingeffectiveness in identifying the contexts for change, applying knowledge, making decisions, and promoting accountability through effective self-management.");

INSERT INTO competency(competencyName, competencyDescription)
VALUES ("Supporting and Delivering theStrategy", "Effective leadership requires the support, contribution, and delivery ofthe strategic vision by developing and agreeing strategic plans that place Kainos values at the heart of the service and ensuring that these are translated into achievable operational plans. Demonstratingeffectiveness in supporting, framing,developing, implementing,and embedding the strategy.");

INSERT INTO competency(competencyName, competencyDescription)
VALUES ("Commerciality and Risk", "Effective leadershiprequires individuals to demonstrate effectiveness within commerciality and risk and supportefficiencies and profitability by maintaining an economic, long term focus in all activities.This includes identifying economic, market and customer issues and using these topromote innovative business models, commercial partnerships, and agreements todeliver greatestvalue –ensuring tight commercial controls of finance,assetsand contracts to meet strategicpriorities.");

INSERT INTO competency(competencyName, competencyDescription)
VALUES ("Communicating and Influence", "Effective leadership requires individuals to be exceptional and confident communicators.  Showing an ability to adapt own style to suit various audiences.  Captivating and engaging others to promote and influence the Kainos vision.  Investing time in others to develop connections and role model our Kainosvalues.");
