...
("Working with others", "Effective leadership requires individuals to work with others in teams and networks to deliver and improve services.  Mobilisingpeople in an inclusive way to drive continuous business improvement."),
...
("Supporting and Delivering theStrategy", "Effective leadership requires the support, contribution, and delivery ofthe strategic vision by developing and agreeing strategic plans that place Kainos values at the heart of the service and ensuring that these are translated into achievable operational plans. Demonstratingeffectiveness in supporting, framing,developing, implementing,and embedding the strategy."),
